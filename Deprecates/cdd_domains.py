...
from cddutils import formatted_domains, network_diagram, network_outfile
import sys
...
strict_types=[ (type(v) for v in strict_fields.values()) ]
strict_defaults=[ v for v in strict_fields.values() ]

def strictnamedtuple(*args, **kwargs):
    print strict_fields, strict_types
    sys.exit()
 #   if len(args) < len(strict_fields):
